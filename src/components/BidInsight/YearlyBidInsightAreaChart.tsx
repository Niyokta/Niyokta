...
export default function YearlyBidInsightAreaChart({refinedData}:{refinedData:{year:String,total:number,accepted:number}[]}){
    ...
    return (
        <Card className="h-[500px]" style={{backgroundColor:div_color}}>
            <CardHeader>
                ...
                <CardDescription>
                    Showing Total and Accepted Bids 
                </CardDescription>
            </CardHeader>
            <CardContent>
                <ChartContainer className="w-full h-[300px] p-[0px]" config={chartConfig}>
                    <AreaChart
                        accessibilityLayer
                        data={chartData}
                        margin={{
